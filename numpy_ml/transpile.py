...
def unify(x, args=None, kwargs=None):
    ...
    """
    return ivy.unify(x, source="numpy", args=args, kwargs=kwargs) 
...
def to_ivy(x, args=None, kwargs=None):
    ...
    - A transpiled Graph or a non-initialized LazyGraph. If the object is a native trainable module,
      ...
      the function will return a copy of the module with every method lazily transpiled.
    """
    return ivy.transpile(x, source="numpy", to='ivy', args=args, kwargs=kwargs)
...
def to_tensorflow(x, args=None, kwargs=None):
    ...
    - A transpiled Graph or a non-initialized LazyGraph. If the object is a native trainable module,
      ...
      the function will return a copy of the module with every method lazily transpiled.
    """
    return ivy.transpile(x, source="numpy", to='tensorflow', args=args, kwargs=kwargs)
...
def to_jax(x, args=None, kwargs=None):
    ...
    - A transpiled Graph or a non-initialized LazyGraph. If the object is a native trainable module,
      ...
      the function will return a copy of the module with every method lazily transpiled.
    """
    return ivy.transpile(x, source="numpy", to='jax', args=args, kwargs=kwargs)

def to_torch(x, args=None, kwargs=None):
    """
    Transpiles a Kornia Callable or set of them from the NumPy framework to the PyTorch Framework.
    If args or kwargs are specified, transpilation is performed eagerly, otherwise, transpilation will happen lazily.
    ...
    - A transpiled Graph or a non-initialized LazyGraph. If the object is a native trainable module,
      ...
      the function will return a copy of the module with every method lazily transpiled.
    """
    return ivy.transpile(x, source="numpy", to='torch', args=args, kwargs=kwargs)
...
def to_paddle(x, args=None, kwargs=None):
    ...
    - A transpiled Graph or a non-initialized LazyGraph. If the object is a native trainable module,
      ...
      the function will return a copy of the module with every method lazily transpiled.
    """
    return ivy.transpile(x, source="numpy", to='paddle', args=args, kwargs=kwargs)